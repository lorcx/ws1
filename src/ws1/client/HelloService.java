 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://ws1/", wsdlLocation = "http://localhost:8080/ws1.Hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://ws1/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ws1.Hello?wsdl");
    ...
    public Hello getHelloServicePort() {
        return super.getPort(new QName("http://ws1/", "HelloServicePort"), Hello.class);
    }
    ...
    public Hello getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws1/", "HelloServicePort"), Hello.class, features);
    }
